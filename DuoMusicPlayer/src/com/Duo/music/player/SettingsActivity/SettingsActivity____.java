...
import com.Duo.music.player.AsyncTasks.AsyncGoogleMusicAuthenticationTask;
import com.Duo.music.player.BlacklistManagerActivity.BlacklistManagerActivity;
import com.Duo.music.player.Helpers.TypefaceHelper;
import com.Duo.music.player.Helpers.UIElementsHelper;
import com.Duo.music.player.InAppBilling.IabResult;
import com.Duo.music.player.InAppBilling.Purchase;
import com.Duo.music.player.Services.AutoFetchAlbumArtService;
	...
	protected void onCreate(Bundle savedInstanceState) {
    	...
    	upgradePreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
			...
			public boolean onPreferenceClick(Preference preference) {
				//initInAppBilling();
				Intent intent = new Intent(mContext, com.Duo.music.player.LauncherActivity.LauncherActivity.class);
